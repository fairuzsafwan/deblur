...
def inference(model_path, img_path, output_path, resized_original_imgpath, img_size):
    ...
    for img_path in img_paths:
        try:
            ...
            input_img = read_inference_image(img_path, img_size=img_size, normalize=True)
            ...
            output_img = np.squeeze(output_data)

            # Post-process the output image (denormalize, clip, convert to uint8)
...
if __name__ == "__main__":
    ...
    output_path = "result_tflite_crop"
